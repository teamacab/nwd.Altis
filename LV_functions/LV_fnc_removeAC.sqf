//ARMA3Alpha function LV_fnc_removeAC v0.6 - by SPUn / lostvar
//removes ambienCombat units in various ways
//Syntax: nul = [handle,style,syncedUnit,range/delay,flee direction] execVM "LV_functions\LV_fnc_removeAC.sqf";
//*handle = the name of ambientCombat, ex: war = [this] execVM "ambientCombat.sqf"; <-war is the handle
...
LV_deleteOnDestination = compile preprocessFile "LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compile preprocessFile "LV_functions\LV_fnc_killAfterDelay.sqf";
